...
return(
<>
<style>{`@media print{body *{visibility:hidden}#resi,#resi *{visibility:visible}#resi{position:fixed;top:0;left:0;width:70mm;padding:3mm;font-family:Arial,sans-serif;font-size:8pt}.no-print{display:none!important}}`}</style>
